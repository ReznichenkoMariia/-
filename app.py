...
class App:
    ...
    def __draw_widgets(self):
        label_upper = Label(text='SEA BATTLE', font=('Arial', 20))
        label_upper.place(x=525, y=15)
    ...
    def __start_placing(self):
        ...
        self.__computer_board = Board(self.__window, '#FFE4E1', App.L, RIGHT, App.NUMBER_OF_SHIPS, App.SIZE)
            ...
            if self.__player_ships.there_are_alive_ships():
                ...
                if (x, y) in self.__player_ships.get_all_possible_cells():
                    if (x, y) in self.__player_ships.get_cells_all_ships_occupy_set():
                        ...
                        self.__player_board.create_rectangle((x * 50, y * 50), ((x + 1) * 50, (y + 1) * 50), '#C0C0C0')
    ...
    def __random_button(self):
        ...
        App.__draw_random_fleet(self.__player_board, self.__player_ships, '#BC8F8F')
